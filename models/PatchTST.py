...
class Model(nn.Module):
    def __init__(self, configs, max_seq_len:Optional[int]=1024, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
        ...
        use_flashattention = configs.use_flashattention
        res_attention = False # removing residual attention
        ...
        if self.decomposition:
            ...
            # print("Decomposition is false")
            if use_flashattention:
                # print("use_flashattention is True")
                res_attention = False
                store_attn = False
                self.model = PatchTST_backbone(c_in=c_in, context_window=context_window, target_window=target_window,
                                               ...
                                               subtract_last=subtract_last, verbose=verbose, flash_attention=use_flashattention, **kwargs)
            else:
                # print("use_flashattention is False")
